	...
	for idx, tMemberInfo in ipairs(arInvite) do-- display group members in an invite
		if tMemberInfo ~= nil then
			...
			if ktInviteClassIcons[tMemberInfo.eClassId] then
				strSpriteToUse = ktInviteClassIcons[tMemberInfo.eClassId]["None"]
			end
...
function BetterPartyFrames:DrawMemberPortrait(tPortrait, tMemberInfo)
	...
	elseif iLevel >= 100 then
		iLevelColor = "ItemQuality_Legendary"
	elseif iLevel >= 80 then
		iLevelColor = "ItemQuality_Superb"
	elseif iLevel >= 60 then
		iLevelColor = "ItemQuality_Excellent"
	elseif iLevel >= 40 then
		iLevelColor = "ItemQuality_Good"
	elseif iLevel >= 20 then
		iLevelColor = "ItemQuality_Average"
	else
	...
	if ktInviteClassIcons[tMemberInfo.eClassId] then
		strClassSprite = ktInviteClassIcons[tMemberInfo.eClassId][role]
	end
	...
	for idx = 1, nMemberCount do
		if tMemberList[idx].unitMentee ~= nil then
			...
			if ktInviteClassIcons[tMemberList[idx].tMemberInfo.eClassId] then
				strClassSprite = ktInviteClassIcons[tMemberList[idx].tMemberInfo.eClassId]["None"]
			end
